...
public class CusPriceListItem {
    ...
    public CusPriceListItem(Long id, Long pricListId, String code, CodeType type, Double price, Double discount, Date startDate, Date endDate, Double saudiVat, Double noneSaudiVat) {
        this.id = id;
        this.pricListId = pricListId;
        this.code = code;
        this.type = type;
