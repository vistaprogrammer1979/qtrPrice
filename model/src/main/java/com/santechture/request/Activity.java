...
//    @JsonDeserialize(using = DateDeserializer.class)
    ...
    @JsonProperty(value ="CoInsurance")
    ...
    @JsonProperty(value = "clinicianSpecialty", required = false)
...
/*
    ...
    public Double getGrossMinusDeductible() {
        if (deductible != null && !deductible.isNaN() && deductible > 0d && gross != null && !gross.isNaN() && gross > 0d ) {
    ...
    public String getClinicianSpecialty() {
        return clinicianSpecialty;
    }

    public void setClinicianSpecialty(String clinicianSpecialty) {
        this.clinicianSpecialty = clinicianSpecialty;
    }
