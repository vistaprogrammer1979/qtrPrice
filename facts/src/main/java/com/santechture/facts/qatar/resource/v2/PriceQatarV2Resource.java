package com.santechture.facts.qatar.resource.v2;

import com.fasterxml.jackson.annotation.JsonInclude;
import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.santechture.facts.exception.GenericGeneralResponse;
import com.santechture.facts.qatar.resource.PriceEngineQatart;
import com.santechture.facts.qatar.resource.PriceQatarResource;
...
@Path("api/v2/qatar")
public class PriceQatarV2Resource {
...
//    @Loggable
    public GenericGeneralResponse<Claim> price(Claim claim, @PathParam("request-id") UUID requestId) throws JsonProcessingException {
        ...
        if (!redisService.isValid()) {
            return new GenericGeneralResponse<Claim>(404, "The requested data in Redis is either corrupted or outdated. " +
                    "Please retry after triggering a cache. If the issue persists, contact support", null);
        }
...
//        dataService.addDataParallel(data);
        ...
        span.end();
        return new GenericGeneralResponse<Claim>(200, "", data.getClaim());
    }
