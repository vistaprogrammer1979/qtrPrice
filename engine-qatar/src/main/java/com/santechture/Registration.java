...
public class Registration {
    ...
    @ConfigProperty(name = "container.name", defaultValue = "price-engine-qatar-1")
    ...
    @ConfigProperty(name = "price.cloud.engine.registration.enable-ttl", defaultValue = "false")
    boolean enableTtl;
    ...
    public void init() {
        ...
        if (status) {
            ...
            if(enableTtl && Objects.equals(defaultProfile, "develop") || Objects.equals(defaultProfile, "dev") ){
                checkOptions =  new CheckOptions().setTtl("3s").setDeregisterAfter("1s");
            }else{
            ...
            client.registerServiceAndAwait(
                    new ServiceOptions()
                            ...
                            .setPort(httpPort)
                            .setAddress(containerName).setName("price-engine-qatar")
                            .setId(this.serverId));
