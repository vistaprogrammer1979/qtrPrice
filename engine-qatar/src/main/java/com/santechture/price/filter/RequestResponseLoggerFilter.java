...
//    private static UUID requestId;
    ...
    public void filter(ContainerRequestContext requestContext) throws IOException {
        log.info("Before process request {} ", requestContext.getProperty(REQUEST_ID_PROPERTY));
    }

    @Override
    public void filter(ContainerRequestContext requestContext, ContainerResponseContext responseContext) {
        log.info("After process request {} with status {}", requestContext.getProperty(REQUEST_ID_PROPERTY), responseContext.getStatus());
